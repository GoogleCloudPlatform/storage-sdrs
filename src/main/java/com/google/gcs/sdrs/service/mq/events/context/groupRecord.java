...
public class groupRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"groupRecord\",\"namespace\":\"com.google.gcs.sdrs.service.mq.events.context\",\"fields\":[{\"name\":\"groupID\",\"type\":\"string\",\"doc\":\"Unique event group ID\"},{\"name\":\"sequenceNumber\",\"type\":\"int\",\"doc\":\"Event sequence in the group. \"},{\"name\":\"totalNumber\",\"type\":\"int\",\"doc\":\"Total number of events in the group.\"}]}");
   ...
   */
  public static com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder newBuilder() {
    return new com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder();
  }
   ...
   * @return A new groupRecord RecordBuilder
   */
  public static com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder newBuilder(com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder other) {
    return new com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder(other);
  }
   ...
   * @return A new groupRecord RecordBuilder
   */
  public static com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder newBuilder(com.google.gcs.sdrs.service.mq.events.context.groupRecord other) {
    return new com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<groupRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.google.gcs.sdrs.service.mq.events.context.groupRecord other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.groupID)) {
        this.groupID = data().deepCopy(fields()[0].schema(), other.groupID);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder setGroupID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder clearGroupID() {
      groupID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder setSequenceNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder clearSequenceNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder setTotalNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.google.gcs.sdrs.service.mq.events.context.groupRecord.Builder clearTotalNumber() {
